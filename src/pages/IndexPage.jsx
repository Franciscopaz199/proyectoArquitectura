          ...
          <>
               <Layout>
                    <ContainerApp>
                         ...
                         <nav className="mt-7 relative z-0 flex border rounded-xl overflow-hidden dark:border-gray-700" aria-label="Tabs" role="tablist">
                              {tabs.map(tab => (
                                   <button
                                        key={tab.id}
                                        type="button"
                                        ...
                                        data-hs-tab={`#bar-with-underline-${tab.id}`}
